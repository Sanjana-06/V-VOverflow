...
class Pest /*Pagable Editable Sortable Table*/ {
    ...
    start_action() {
        this.GetRecordCount().then(totRecs => {
    ...
    static MakeHTML(uidSuffix, actualobject) {
        let TheHTML =
            `<PEST _OBJECT_ uid__SUFFIX_>
                ...
                <hr />
                    <div class ="title  d-none" _TOTAL_RECORDS_>
                        <h6 id="_TOTALRECORDS_" class ="title"></h6>
                    </div>
                    <div class ="title  d-none" _TOTAL_PAGES_>
                        <h6 id="_TOTALPAGES_" class ="title"></h6>
                    </div>
                    <div class ="title d-none" _RECORDS_PER_PAGE_>
                        <h6 class ="title">- Records Per page =</h6>
                    ...
                    <div class ="title d-none" _CURRENT_PAGE_>
                        <h5 class ="title" id="_CURRENTPAGE_"></h5>
                    </div>
                    ...
                    <div class ="pageBar d-none" _PAGE_BAR_>
    ...
    makeTable(mydata) {
        ...
        $.each(mydata, (index, value) => {
            ...
            //    TableRow += "<td>" + val + "</td>";
            //});
            for (let k in that.ControlConfig.headerMapping) TableRow += "<td>" + value[k] + "</td>";
